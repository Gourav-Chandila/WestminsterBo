...
public class TestPremiseAppTestServerSf extends BaseTest{
	...
	public void fillingApplicantDetails(Method methodName) {
		...
		String otherApplicant = "health_service_applicant";// individual_applicant,limited_company_applicant,partnership_applicant,
															// unincoporated_applicant,other_applicant,recognised_club_applicant,charity_applicant,educational_applicant,health_service_applicant,registered_individual_wales_applicant,registered_individual_wales_applicant,registered_individual_england_applicant,chief_officer_applicant
		String ApplicantCheckbox = "applicant_type_carry_on";// Accepts
																// applicant_type_carry_on,applicant_type_function_discharged
		String shadowCheckbox = "product_type_neither";// Accepts
														// product_type_neither,product_type_shadow,product_type_provisional
		String Message = premise.fillApplicantDetails(driver, business, otherApplicant, ApplicantCheckbox,
				shadowCheckbox);// takes args Test Business
		// name,Other
	...
	public void fillPremisesDetails(Method methodName) {
		logger = extent.createTest(methodName.getName());
		String underConstructionIdValue = "is_under_construction_no"; // Accepts
																		// is_under_construction_yes,is_under_construction_no
		String serveAlcoholOptionValue = "serve_alcohol_flag_no"; // Accepts
																	// serve_alcohol_flag_yes,serve_alcohol_flag_no
		String childerenAccessOption = "access_for_children_restricted"; // Accepts
																			// access_for_children_restricted,access_for_children_prohibited,access_for_children_neither
		String Message = premise.fillPremisesDetails(driver, underConstructionIdValue, serveAlcoholOptionValue,
				childerenAccessOption);
	...
	public void payment(Method methodName) {
		logger = extent.createTest(methodName.getName());
		String Message = premise.addPayment(driver,"");
