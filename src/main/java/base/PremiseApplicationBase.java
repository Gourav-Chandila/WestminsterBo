...
public abstract class PremiseApplicationBase {
	...
	public String fillApplicantDetails(WebDriver driver, String licenceAs, String otherAppplicant,
		...
		try {
			...
			WebElement iAmApplyingForTheLicenceAsDropdown = ele.getWebElement("XPATH",PremiseApplicationElements.iAmApplyingForTheLicenceAsDropdown);
			WebElement element = SeleniumUtils.waitForElementToBeDisplayed(driver, iAmApplyingForTheLicenceAsDropdown,Duration.ofSeconds(5));
			element.click();
			
			// CLick on licence as dropdown option
			ele.getWebElement("XPATH", PremiseApplicationElements.iAmApplyingForTheLicenceAsDropdownOption(licenceAs)).click();
			
			//Add details button
			WebElement addApplicantDetailsButton = ele.getWebElement("XPATH",PremiseApplicationElements.addApplicantDetailsButton);
			WebElement addApplicantDetailsButtonElement = SeleniumUtils.waitForElementToBeDisplayed(driver, addApplicantDetailsButton,Duration.ofSeconds(5));
			...
			ele.getWebElement("ID", PremiseApplicationElements.otherApplicantNameInput).sendKeys("Test other applicant name");
			enterAddressDetails(PremiseApplicationElements.otherApplicantAddressSearchButton);
			ele.getWebElement("ID", PremiseApplicationElements.otherApplicantRegisteredNumberInput).sendKeys("+44567897689");
			ele.getWebElement("ID", PremiseApplicationElements.otherApplicantDescriptionInput).sendKeys("Test other applicant description");
			ele.getWebElement("ID", PremiseApplicationElements.otherApplicantTelephoneInput).sendKeys("+445623986756");
			ele.getWebElement("ID", PremiseApplicationElements.otherApplicantEmailInput).sendKeys("testotherapplicant@fgl.com");
	...
	public String designatedPremisesSupervisor(WebDriver driver) {
		try {
			...
			WebElement addDesignatedPremisesSupervisorButton = ele.getWebElement("XPATH",PremiseApplicationElements.addDesignatedPremisesSupervisorButton);
			WebElement addDesignatedPremisesSupervisorButtonElement = SeleniumUtils.waitForElementToBeDisplayed(driver, addDesignatedPremisesSupervisorButton,Duration.ofSeconds(5));
	...
	public String uploadApplicationEvidence(WebDriver driver) {
		try {
			...
			ele.getWebElement("ID", PremiseApplicationElements.applicationEvidenceDescriptionInput).sendKeys("test description");
	...
	public String fillPremisesDetails(WebDriver driver, String underConstructionId, String alcoholOption,
		...
		try {
			...
			if (underConstructionId.equals("is_under_construction_yes")) {
				ele.getWebElement("ID",PremiseApplicationElements.premiseDetailsUnderConstructionOption(underConstructionId)).click();
			} else {
				ele.getWebElement("ID",PremiseApplicationElements.premiseDetailsUnderConstructionOption(underConstructionId)).click();
	...
	public String fillBusinessHours(WebDriver driver) {
		try {
			...
			fillHours(driver);
			ele.getWebElement("ID", PremiseApplicationElements.seasonalVariationsInput).sendKeys("test seasonal variations");
			ele.getWebElement("ID", PremiseApplicationElements.nonStandardTimingsInput).sendKeys("test non standard timings");
	...
	public String fillOperatingSchedule(WebDriver driver) {
		try {
			...
			ele.getWebElement("ID", PremiseApplicationElements.activitySeasonalVariationsInput).sendKeys("test seasonal variations");
			ele.getWebElement("ID", PremiseApplicationElements.activityNonStandardTimingsInput).sendKeys("test non standard timing");
